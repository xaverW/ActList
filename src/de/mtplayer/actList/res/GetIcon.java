...
public class GetIcon {
    ...
    private final static String PATH_PROGRAM = "/de/mtplayer/actList/res/programm/";
    private final static String PATH_SENDER = "/de/mtplayer/actList/res/sender/";
    private final static String PATH_RES = "/de/mtplayer/actList/res/";
