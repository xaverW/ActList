...
package de.mtplayer.actList.res;
...
public class GetIcon {
    ...
    private final static String PFAD_PROGRAMM = "/de/mtplayer/actList/res/programm/";
    private final static String PFAD_SENDER = "/de/mtplayer/actList/res/sender/";
    private final static String PFAD_RES = "/de/mtplayer/actList/res/";
