...
public class ProgConfig extends MLConfig {
    ...
    public static MLConfigs SYSTEM_FILMLIST_SIZE = addNewKey("system-filmlist-size", "");
    public static MLConfigs SYSTEM_FILMLIST_USED = addNewKey("system-filmlist-used", "");
    public static MLConfigs SYSTEM_FILMLIST_DATE_LOCAL_TIME = addNewKey("system-filmlist-date-local-time", "");
