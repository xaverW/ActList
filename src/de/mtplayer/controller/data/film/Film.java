        ...
        if (!arr[FilmXml.FILM_DATUM].isEmpty()) {
            ...
            try {
                if (arr[FilmXml.FILM_DATUM_LONG].isEmpty()) {
                    if (arr[FilmXml.FILM_ZEIT].isEmpty()) {
                        datumFilm = new DatumFilm(sdf_datum.parse(arr[FilmXml.FILM_DATUM]).getTime());
                    } else {
                        datumFilm = new DatumFilm(sdf_datum_zeit.parse(arr[FilmXml.FILM_DATUM] + arr[FilmXml.FILM_ZEIT]).getTime());
                    }
