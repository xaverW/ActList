...
public class GetFile {
    ...
    public static final String PFAD_PSET_LINUX = "/de/mtplayer/tools/file/pset_linux.xml";
    public static final String PFAD_PSET_WINDOWS = "/de/mtplayer/tools/file/pset_windows.xml";
    public static final String PFAD_PSET_MAC = "/de/mtplayer/tools/file/pset_mac.xml";
    public static final String PFAD_HILFETEXT_PRGRAMME = "/de/mtplayer/tools/file/hilfetext_pset.txt";
